...
public class AssessmentServiceTest {
	...
	public void setup() {
		...
		when(assessmentRepository.findAssessmentsByBatchIdAndWeekNumber(84, 2)).thenReturn(batchAndWeekNumAssessmentsList);
	...
	public void testFindAssessmentsByCategoryWithExpectedInput() {
		assertThat(assessmentRepository.findAssessmentsByAssessmentCategory(9), hasItems(
				new Assessment(22, 87, "a4", "java", 2, 84, 9)
		));
	}
